// ============================================================
// ModernTech Solutions — Employee Directory (dummy dataset)
// Embedded directly (rather than fetched) so these pages work
// when opened straight from the filesystem, no local server needed.
// ============================================================
